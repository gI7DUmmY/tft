    ...
    <main className='w-full min-h-screen font-sans  text-black'>
      ...
      <div className='px-3 pt-3 text-justify page-content md:px-9'>
        ...
        <p>
          ...
          intéressées la première séance d’entraînement, afin de vous faire une
          idée sur le fonctionnement du club.
        </p>
        <p>
        ...
        <Accordeon header='choisissez votre licence' number={one}>
          <div>
            <p>
              ...
              augmentera avec le temps&#41;, mais plutôt du type de pratique et
              de &quot;l’esprit&quot; que vous recherchez :
            </p>
            <ul>
            ...
            <ul>
              <li className='block my-1'>
                <span className='underline'>
                  La licence comp&eacute;tition : 100€ &#40;40€ pour les moins
                  de 18ans&#41;
                </span>
                <br />
                ...
                totalité des tournois de football de table, y compris nationaux
                et internationaux.
              </li>
              <li className='block my-1'>
                <span className='underline'>
              ...
              <li className='block my-1'>
                ...
                <br />
                Cette licence vous permettra de participer aux tournois
                &quot;Open Decouverte&quot; &#40;c’est à dire locaux&#41; et aux
                tournois non officiels &#40;DYP&#41;.
              </li>
            </ul>
            <p className='font-semibold'>
              Si vous n’arrivez pas à vous décider pas de panique, un
              responsable de club sera ravi de vous conseiller.
            </p>
          </div>
        </Accordeon>
